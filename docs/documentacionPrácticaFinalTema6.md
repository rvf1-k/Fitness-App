...
Este proyecto se encuentra alojado en [GitHub](https://github.com/rvf1-k/Fitness-App).
...
- Mejora de clases con `.item` y `.btn`, para separar los estilos entre `div` y botones.

### Animación de inicio

Al acceder a la web por primera vez, el _popup_ que daba la bienvenida tiene animaciones realizadas con Jquery. Se utilizan los métodos `height()` y `outerHeight()` para calcular la animación en base a la pantalla.

> Ver en código [**JavaScript**](https://github.com/rvf1-k/Fitness-App/blob/jquery/app.js#L917).

### Slide

Se ha añadido un elemento _slide_ que funciona como tutorial, este es expansible y no se retrae hasta pulsar el botón de nuevo.

> Ver en [**HTML**](https://github.com/rvf1-k/Fitness-App/blob/jquery/index.html#L174-L190), [**JavaScript**](https://github.com/rvf1-k/Fitness-App/blob/jquery/app.js#L327-L329).

### Fade

Se ha incluido mi nombre en forma de botón en la zona superior, cuando el ratón se posa aparece un mensaje con fade.

> Ver en [**HTML**](https://github.com/rvf1-k/Fitness-App/blob/jquery/index.html#L48-L58), [**JavaScript**](https://github.com/rvf1-k/Fitness-App/blob/jquery/app.js#L353-L363).

### SlideShow

Las imágenes tienen integradas [**fancybox**](https://fancyapps.com/fancybox/) y [**carousel**](https://fancyapps.com/carousel/). En este se ha utilizado el método `css` para que solo aparezcan las flechas cuando estás sobre su contenedor.

> Ver en [**HTML**](https://github.com/rvf1-k/Fitness-App/blob/jquery/index.html#L65-L116), [**JavaScript**](https://github.com/rvf1-k/Fitness-App/blob/jquery/app.js#L343-L351).
